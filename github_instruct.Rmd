...
If you want to practice with a partner I included a lab from last year that has you partner up with a classmate and work in the same document. Please refer to Lab 7 Part 1_git collab in the src folder and work through it with a partner sometime.

1. Invite Renae to collab

2. Have her clone in

3. I'll make an edit to the repo and push

4. Now I need Renae's skills to add a cool graph

5. She pulls, stages, commits, and pushes

6. I'll show the edits worked on my computer after pulling in
